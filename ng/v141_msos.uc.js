...
msos.console.info('ng/v141_msos -> start.');
...
(function (window, document) {
    ...
    var angular = {},
        version = {
            ...
            minor: 3,
            dot: 1,
            codeName: 'hyperionic_illumination_msos'
        },
        NODE_TYPE_ELEMENT = 1,
        ...
        $AnimateProvider = [],
        $$HashMapProvider = [],
        $$CoreAnimateRunnerProvider = null,
    ...
    function isTypedArray(value) {
        return TYPED_ARRAY_REGEXP.test(ngto_string.call(value));
    }
    ...
    function urlResolve(url, note) {
        ...
        if (msos.config.verbose) {
            msos.console.debug('ng - urlResolve -> start,\n     url: ' + url + (note ? ',\n     ref: ' + note : ''));
        }
    ...
    // Only used in pre v141 selectDirective!
    ...
    function baseExtend(dst, objs, deep) {
        ...
        for (i = 0, ii = objs.length; i < ii; i += 1) {
            ...
            // Note: this uses underscore.js _.isObject!
            if (_.isObject(obj)) {
        ...
        if (!destination) {
            ...
            if (isObject(source)) {
                ...
                if (isTypedArray(source)) {
                    ...
                    emptyObject = Object.create(getPrototypeOf(source));
    ...
    function equals(o1, o2) {
        ...
        if (typeof o1 === 'object' && typeof o2 === 'object') {
            ...
            if (_.isRegExp(o1)) {
                return _.isRegExp(o2) ? o1.toString() === o2.toString() : false;
            }

            if (isScope(o1) || isScope(o2) || isWindow(o1) || isWindow(o2) || _.isArray(o2) || _.isDate(o2) || _.isRegExp(o2)) {
                return false;
            }
    ...
    function bindJQuery() {
        ...
        msos.console.debug(temp_bj + 'done!');
    ...
    function setupModuleLoader(window) {
        ...
        function ensure(obj, e_name, factory) {
            ...
            if (msos.config.verbose) {
                msos.console.debug(temp_sm + ' - ensure -> ' + e_name + ', (' + debug + ')');
            }
        ...
        angular_module = ensure(angular, 'module', function () {
            ...
            return function module(m_name, requires, configFn) {
                ...
                if (vb) {
                    msos.console.debug(temp_sm + ' - module -> start: ' + m_name);
                }
                ...
                if (vb) {
                    msos.console.debug(temp_sm + ' - module ->  done: ' + m_name);
                }
                ...
                return ensure(modules, m_name, function () {
                    ...
                    if (vb) {
                        msos.console.debug(temp_sm + temp_em + ' -> start: ' + m_name);
                    }
                    ...
                    function invokeLater(provider, method, insertMethod, queue) {
                        ...
                        return function () {
                            if (vb) {
                                msos.console.debug(temp_sm + temp_em + ' -> invokeLater,\n     for: ' + m_name + '::' + method);
                            }
                    ...
                    function invokeLaterAndSetModuleName(provider, method) {
                        return function (recipeName, factoryFunction) {
                            if (vb) {
                                msos.console.debug(temp_sm + temp_em + ' -> invokeLaterAndSetModuleName,\n     for: ' + m_name + '::' + recipeName + '::' + method);
                            }
                    ...
                    if (vb) {
                        msos.console.debug(temp_sm + temp_em + ' ->  done: ' + m_name);
                    }
    ...
    function annotate(fn, strictDi, name) {
        ...
        if (msos.config.verbose === 'injector') {
    ...
    function createInjector(modulesToLoad, strictDi) {
        ...
        function createInternalInjector(cache, factory) {
            ...
            function getService(serviceName, caller) {
                ...
                if (vb === 'injector') {
                    msos.console.debug(temp_ci + temp_cii + ' - getService -> start' + debug_out);
                }
                ...
                if (cache.hasOwnProperty(serviceName)) {
                    ...
                    if (vb === 'injector') {
                        msos.console.debug(temp_ci + temp_cii + ' - getService ->  done (exists)' + debug_out);
                    }
                ...
                if (vb === 'injector') {
                    msos.console.debug(temp_ci + temp_cii + ' - getService ->  done (created)' + debug_out);
                }
            ...
            function invoke(fn, self, locals, serviceName) {
                ...
                if (vb === 'injector') {
                    ...
                    msos.console.debug(temp_ci + temp_cii + ' - invoke -> start' + invoke_name);
                }
                ...
                if (vb === 'injector') {
                    msos.console.debug(temp_ci + temp_cii + ' - invoke ->  done' + (debug.length ? ': [' + debug.join(', ') + ']' : invoke_name));
                }
            ...
            if (vb === 'injector') {
                msos.console.debug(temp_ci + temp_cii + ' ->  done!');
            }
        ...
        providerCache.$injector = createInternalInjector(
            ...
            function (serviceName, caller) {
                ...
                throw $injectorMinErr('unpr', temp_pc, path.join(' <- '));
            }
        );
        ...
        function loadModules(modulesToLoad) {
            ...
            if (modulesToLoad.length === 0) {
                msos.console.debug(temp_ci + temp_lm + ' done, no input.');
                return runBlocks;
            }
            ...
            forEach(
                ...
                function (module) {
                    ...
                    msos.console.debug(temp_ci + temp_lm + '(foreach) start, module: ' + module_name);
                    ...
                    msos.console.debug(temp_ci + temp_lm + '(foreach)  done, module: ' + module_name + ', loaded ' + debug_note.join(', '));
                }
            );
    ...
    function bootstrap(element, modules, config) {
        ...
        if (bindbootstrapFired) {
            msos.console.warn(temp_b + ' -> done, already fired!');
            return undefined;
        }
    ...
    $$CoreAnimateRunnerProvider = function () {
    ...
    $AnimateProvider = ['$provide', function ($provide) {
        ...
        this.register = function (name, factory) {
            ...
            msos.console.debug('ng - $AnimateProvider - register -> called, for: ' + (name ? name : "'' (empty string)"));
    ...
    function Browser(window, document) {
        ...
        self.url = function (url, replace, state) {
            ...
            if (vb) {
                msos.console.debug(temp_br + ' - url -> ' + (url ? 'setter start,\n     ' + url + ',' : 'getter start.'));
            }
            ...
            if (url) {
                ...
                if (lastBrowserUrl === url && (!Modernizr.history || sameState)) {
                    if (vb) {
                        msos.console.debug(temp_br + ' - url -> setter done, no change!');
                    }
                    return self;
                }
            ...
            if (vb) {
                msos.console.debug(temp_br + ' - url -> getter done (Larry the Cable Guy),\n     url: ' + out_url);
            }
        ...
        function fireUrlChange() {
            ...
            msos.console.debug(temp_br + ' - fireUrlChange -> start.');

            self_url = self.url();

            if (lastBrowserUrl === self_url && lastHistoryState === cachedState) {
                msos.console.debug(temp_br + ' - fireUrlChange -> no change!');
                return;
            }

            lastBrowserUrl = self_url;
            lastHistoryState = cachedState;

            forEach(
                urlChangeListeners,
                function (listener) {
                    listener(self_url, cachedState);
                }
            );

            msos.console.debug(temp_br + ' - fireUrlChange -> done!');
        }

        function cacheStateAndFireUrlChange() {
            var temp_cs = ' - cacheStateAndFireUrlChange -> ';

            msos.console.debug(temp_br + temp_cs + 'start.');

            cacheState();
            self.$$checkUrlChange();

            msos.console.debug(temp_br + temp_cs + 'done!');
        }
        ...
        self.$$applicationDestroyed = function () {
            ...
            msos.console.debug(temp_br + ' - $$applicationDestroyed -> called.');
        ...
        self.$$checkUrlChange = function () {
            ...
            msos.console.debug(temp_br + ' - $$checkUrlChange -> start.');

            check_url = self.url();

            if (lastBrowserUrl === check_url
             && lastHistoryState === cachedState) {
                msos.console.debug(temp_br + ' - $$checkUrlChange -> done, no change!');
                return;
            }

            msos.console.debug(temp_br + ' - $$checkUrlChange -> update for new url:\n     ' + check_url);
            ...
            msos.console.debug(temp_br + ' - $$checkUrlChange -> done!');
        };
    ...
    function identifierForController(controller, ident) {
        ...
        if (_.isString(controller)) {
            var match = CNTRL_REGEXP.exec(controller);
    ...
    function $CompileProvider($provide, $$sanitizeUriProvider) {
        ...
        this.$get = [
            ...
            msos.console.debug(temp_cp + ' - $get -> start.');
            ...
            Attributes.prototype = {
                ...
                $set: function (key, value, writeAttr, attrName) {
                    ...
                    if (vc) {
                        msos.console.debug(temp_cp + temp_st + 'start' + db_name_attr);
                    }
                    ...
                    if ((nodeName === 'a' && key === 'href') || (nodeName === 'img' && key === 'src')) {
                        ...
                        if (vc) {
                            msos.console.debug(temp_cp + temp_st + 'unchecked' + db_name_attr + ': ' + value);
                        }
                    ...
                    if (writeAttr !== false) {
                        if (value === null || value === undefined) {
                            if (vc) {
                                msos.console.debug(temp_cp + temp_st + 'remove attribute' + db_name_attr);
                            }
                    ...
                    if (vc) {
                        msos.console.debug(temp_cp + temp_st + ' done' + db_name_attr);
                    }
                },
            ...
            function addAttrInterpolateDirective(node, directives, value, name, allOrNothing) {
                ...
                if (vc) {
                    msos.console.debug(temp_cp + ' - $get - addAttrInterpolateDirective -> start.');
                }
                ...
                if (!interpolateFn) {
                    if (vc) {
                        msos.console.debug(temp_cp + ' - $get - addAttrInterpolateDirective -> done, no interpolation function.');
                    }
                    return;
                }
                ...
                if (vc) {
                    msos.console.debug(temp_cp + ' - $get - addAttrInterpolateDirective -> done!');
                }
            }

            function addTextInterpolateDirective(directives, text) {
                if (vc) {
                    msos.console.debug(temp_cp + ' - $get - addTextInterpolateDirective -> start.');
                }
                ...
                if (vc) {
                    msos.console.debug(temp_cp + ' - $get - addTextInterpolateDirective -> done!');
                }
            }
            ...
            function collectDirectives(node, directives, attrs, maxPriority, ignoreDirective) {
                ...
                switch (nodeType) {
                    ...
                    case NODE_TYPE_ELEMENT:
                        ...
                        norm_name = directiveNormalize(nodeName_(node));

                        nAttrs = node.attributes;

                        if (nAttrs && nAttrs.length) { jj = nAttrs.length; }

                        // If no attributes at all (not likely)
                        if (jj === 0) {

                            if (vc) {
                                msos.console.debug(temp_cp + temp_cd + 'type element, add name Directive (no attributes): ' + norm_name);
                            }
                        ...
                        for (j = 0; j < jj; j += 1) {
                            ...
                            // Do this once, and only once on first run thru
                            if (j === 0 && nName !== 'ngIgnore') {

                                if (vc) {
                                    msos.console.debug(temp_cp + temp_cd + 'type element, add name Directive: ' + nName + ':' + norm_name);
                                }
                            ...
                            if (nName !== 'ngIgnore') {
                                ...
                                if (vc) {
                                    msos.console.debug(temp_cp + temp_cd + 'type element, add attribute Directive: ' + nName + ', isNgAttr: ' + isNgAttr);
                                }
                                ...
                                msos.console.debug(temp_cp + temp_cd + 'type element, skipped: ' + node_name + ', for: ' + nName);
                            }
                        }
                    ...
                    case NODE_TYPE_TEXT:
                        ...
                        if (vc) {
                            msos.console.debug(temp_cp + temp_cd + 'type text, add Directives.');
                        }
                ...
                if (msos.config.verbose || directives.length) {
                    msos.console.debug(temp_cp + temp_cd + ' done, for: ' + node_name + ', # of directives: ' + directives.length);
                }
            ...
            function compileNodes(nodeList, transcludeFn, $rootElement, maxPriority, ignoreDirective, previousCompileContext_cn) {
                ...
                if (msos.config.verbose) {
                    msos.console.debug(temp_cp + temp_cn + 'start, iteration: ' + m);
                }
                    ...
                    for (i = 0; i < linkFns.length; i += 1) {
                        ...
                        if (nodeLinkFn_cLF) {
                            if (nodeLinkFn_cLF.scope) {
                                ...
                                destroyBindings = nodeLinkFn_cLF.$$destroyBindings;
                                if (destroyBindings) {
                                    nodeLinkFn_cLF.$$destroyBindings = null;
                ...
                if (msos.config.verbose) {
                        msos.console.debug(temp_cp + temp_cn + ' done, iteration: ' + m + (debug_cn.length ? ',\n     ' + debug_cn.join(',\n     ') : ''));
                }
            ...
            applyDirectivesToNode = function (directives, compileNode, templateAttrs, transcludeFn, jqCollection, originalReplaceDirective, preLinkFns, postLinkFns, previousCompileContext_apply) {
                ...
                if (vc) {
                    msos.console.debug(temp_cp + temp_ap + 'start, node: ' + lowercase(compileNode.nodeName + ', prev. context: '), previousCompileContext_apply);
                }
                ...
                function initializeDirectiveBindings(scope, attrs, destination, bindings, directive, newScope) {
                    ...
                    destroyBindings = onNewScopeDestroyed
                        ? function destroyBindings() {
                            var i = 0,
                                ii = 0;

                            for (i = 0, ii = onNewScopeDestroyed.length; i < ii; i += 1) {
                ...
                function nodeLinkFn(childLinkFn, scope, linkNode, $rootElement, boundTranscludeFn, thisLinkFn) {
                    ...
                    if (elementControllers) {
                        ...
                        scopeDirective = newIsolateScopeDirective || newScopeDirective;
                        ...
                        for (ctrlr_key in elementControllers) {
                            ...
                            if (controllerResult !== controller.instance) {
                                ...
                                $element.data('$' + ctrlr_key + 'Controller', controllerResult);
                ...
                for (i = 0; i < ii; i += 1) {
                    ...
                    if (directiveValue) {
                        ...
                        if (!directive.$$tlb) {
                            ...
                            msos.console.debug(temp_cp + temp_ap + 'processing no $$tlb: ' + directiveName);
                        ...
                        if (directiveValue === 'element') {
                            ...
                            msos.console.debug(temp_cp + temp_ap + 'processing template (element): ' + directiveName);
                            ...
                            msos.console.debug(temp_cp + temp_ap + 'processing template (contents): ' + directiveName);
            ...
            compile = function ($compileNodes, transcludeFn, maxPriority, ignoreDirective, previousCompileContext_compile) {
                ...
                if (previousCompileContext_compile) {
                    msos.console.debug(temp_cp + temp_c + 'prev. context:', previousCompileContext_compile);
                }
        ...
        this.$get = ['$injector', '$window', function ($injector, $window) {
            ...
            return function (expression, locals, later, ident) {
                ...
                if (_.isString(expression)) {
                    match = expression.match(CNTRL_REGEXP);
    ...
    function createHttpBackend($browser, createXhr, $browserDefer, callbacks, rawDocument) {
        ...
        msos.console.debug(temp_ch + ' -> start.');
        ...
        function jsonpReq(url, callbackId, done) {
            ...
            msos.console.debug(temp_ch + ' - jsonpReq -> start.');
            ...
            callback = function (event) {
                ...
                msos.console.debug(temp_ch + ' - jsonpReq - callback -> start.');
                ...
                msos.console.debug(temp_ch + ' - jsonpReq - callback -> done!');
            };
            ...
            msos.console.debug(temp_ch + ' - jsonpReq -> done!');
            return callback;
        }

        msos.console.debug(temp_ch + ' -> done.');
        ...
        return function (method, url, post, callback, headers, timeout, withCredentials, responseType) {
            ...
            msos.console.debug(temp_ch + ' returned function -> start.');
            ...
            msos.console.debug(temp_ch + ' returned function -> done!');
        };
    }
    ...
    function $IntervalProvider() {
        this.$get = ['$rootScope', '$window', '$q', '$$q', function ($rootScope, $window, $q, $$q) {
            ...
            function interval(fn, delay, count, invokeApply) {
                ...
                if (msos.config.debug) {
                    msos.console.info(temp_ipg + temp_in + ' -> start, name: ' + promise.$$state.name);
                }
                ...
                promise.$$intervalId = setInterval(
                    function tick() {
                        ...
                        msos.console.debug(temp_ipg + temp_in + ' - tick -> start' + debug_out);
                        ...
                        msos.console.debug(temp_ipg + temp_in + ' - tick ->  done' + debug_out);
                    },
                    delay
                );
    ...
    function LocationHtml5Url(appBase, basePrefix) {
        ...
        this.$$parse = function (url) {
            ...
            msos.console.debug(temp_lh5 + ' - $$parse -> start,\n     url: ' + url);
        ...
        this.$$parseLinkUrl = function (url, relHref) {
            ...
            msos.console.debug(temp_lh5 + ' - $$parseLinkUrl -> start.');
            ...
            if (relHref && relHref[0] === '#') {
                ...
                msos.console.debug(temp_lh5 + ' - $$parseLinkUrl -> done, for #');
                return true;
            }
            ...
            msos.console.debug(temp_lh5 + ' - $$parseLinkUrl -> done, rewritten: ' + !!rewrittenUrl);
            return !!rewrittenUrl;
        };
    ...
    function LocationHashbangUrl(appBase, hashPrefix) {
        ...
        this.$$parse = function (url) {
            ...
            msos.console.debug(temp_hb + ' - $$parse -> start,\n     url: ' + url);
        ...
        this.$$parseLinkUrl = function (url) {
            ...
            msos.console.debug(temp_hb + temp_pu + 'start.');

            if (stripHash(appBase) === stripHash(url)) {
                this.$$parse(url);
    
                msos.console.debug(temp_hb + temp_pu + 'done: true');
                return true;
            }

            msos.console.debug(temp_hb + temp_pu + 'done: false');
            return false;
        };
    ...
    function LocationHashbangInHtml5Url(appBase, hashPrefix) {
        ...
        msos.console.debug(temp_5u + ' -> start.');
        ...
        this.$$parseLinkUrl = function (url, relHref) {
            ...
            msos.console.debug(temp_5u + temp_pl + 'start.');
            ...
            msos.console.debug(temp_5u + temp_pl + 'done, rewritten: ' + !!rewrittenUrl);
        ...
        msos.console.debug(temp_5u + ' -> done!');
    }
    ...
    function $LocationProvider() {
        ...
        this.$get = ['$rootScope', '$browser', '$rootElement', function ($rootScope, $browser, $rootElement) {
            ...
            if (trimEmptyHash(rewrite_url) !== trimEmptyHash(initialUrl)) {
                ...
                msos.console.debug(temp_lp + ' - get -> rewrite hashbang url <> html5 url:\n     ', rewrite_url);
            ...
            function setBrowserUrlWithFallback(url, replace, state) {
                ...
                msos.console.debug(temp_lp + temp_sbf + 'start.');
                ...
                msos.console.debug(temp_lp + temp_sbf + 'done!');
            }
            ...
            function create_eval_async_func(new_url) {
                ...
                $rootScope.$evalAsync(
                    function () {
                        ...
                        msos.console.debug(temp_lp + temp_re + 'called.');
                        ...
                        if ($location_LP.absUrl() !== new_url) {
                            msos.console.debug(temp_lp + temp_re + 'url already changed ($locationChangeStart)');
                            return;
                        }

                        if (defaultPrevented) {

                            msos.console.debug(temp_lp + temp_re + 'default prevented');
                            ...
                            msos.console.debug(temp_lp + temp_re + 'change success');
            ...
            if (msos.config.verbose) {
                msos.console.debug(temp_lp + ' - $get -> set $browser.onUrlChange');
            }
            ...
            $browser.onUrlChange(
                function (newUrl) {
                    ...
                    msos.console.debug(temp_lp + temp_bo + ' -> start, for new url:\n     ' + newUrl);

                    create_eval_async_func(newUrl);

                    if (!$rootScope.$$phase) { $rootScope.$digest(); }

                    msos.console.debug(temp_lp + temp_bo + ' -> done!');
                }
            );

            if (msos.config.verbose) {
                msos.console.debug(temp_lp + ' - $get -> set $rootScope.$watch');
            }

            // Update browser
            $rootScope.$watch(
                function $locationWatch() {
                    var temp_lw = ' - $get - $rootScope.$watch - $locationWatch',
                        debug_lw = 'no change',
                        oldUrl,
                        oldState,
                    ...
                    msos.console.debug(temp_lp + temp_lw + ' -> start (' + location_watch_count + '),\n     for url: ' + newUrl);
                    ...
                    msos.console.debug(temp_lp + temp_lw + ' ->  done (' + location_watch_count + '), for: ' + debug_lw);
                }
            );
    ...
    function ensureSafeObject(obj, fullExpression) {
        ...
        if (msos.config.debug === 'safe') {
            msos.console.debug(temp_es + 'start, expression: ' + fullExpression);
        }
        ...
        if (msos.config.debug === 'safe') {
            msos.console.debug(temp_es + ' done, expression: ' + fullExpression + ',' + debug_out);
        }
        return obj;
    }
    ...
    function ensureSafeFunction(obj, fullExpression) {
        ...
        if (msos.config.debug === 'safe') {
            msos.console.debug(temp_esf + 'start, expression: ' + fullExpression);
        }
        ...
        if (msos.config.debug === 'safe') {
            msos.console.debug(temp_esf + ' done, expression: ' + fullExpression + ',' + debug_out);
        }
        return obj;
    }
 ...
 */
    ...
    function $$RAFProvider() { //rAF
        this.$get = ['$window', '$timeout', function ($window, $timeout) {
            ...
            function flush() {
                ...
                for (i = 0; i < taskQueue.length; i += 1) {
                    task = taskQueue[i];
                    if (task) {
                        taskQueue[i] = null;
                        task();
    ...
    function $RootScopeProvider() {
        ...
        this.$get = ['$parse', '$browser', function ($parse, $browser) {
            ...
            function incrementWatchersCount(current, increment, name) {
                ...
                if (rvs) {
                    msos.console.debug(temp_il + 'called, by: ' + name + ', increment by: ' + increment);
                }
            ...
            function decrementListenerCount(current, increment, ev_name) {
                ...
                msos.console.debug(temp_dl + 'called, event: ' + ev_name + ', increment: ' + increment);
            ...
            Scope.prototype = {
                ...
                $watch: function (watchExp, listener, objectEquality, prettyPrintExpression) {
                    ...
                    if (rvs) {
                        ...
                        msos.console.debug(temp_rsp + '$get - Scope.$watch -> start, for: ' + expr_name);
                    }

                    if (get.$$watchDelegate) {

                        if (rvs) {
                            msos.console.debug(temp_rsp + '$get - Scope.$watch ->  done, use get.$$watchDelegate');
                        }
                    ...
                    if (rvs) {
                        msos.console.debug(temp_rsp + '$get - Scope.$watch ->  done!');
                    }

                    return function deregisterWatch() {
                        if (rvs) {
                            msos.console.debug(temp_rsp + '$get - Scope.$watch - deregisterWatch -> called.');
                        }
                ...
                $digest: function () {
                    ...
                    msos.console.debug(temp_rsp + temp_dg + 'start, asyncQueue: ' + asyncQueue.length + ', postDigestQueue: ' + postDigestQueue.length);
                    ...
                    if (this === $rootScope_P && applyAsyncId !== null) {
                        ...
                        msos.console.debug(temp_rsp + temp_dg + 'for root scope and applyAsyncId, cancel $browser.defer');
                    ...
                    msos.console.debug(temp_rsp + temp_dg + 'done, processed - async queue: ' + process_async_queue + ', post digest queue: ' + process_post_queue);
                },
                ...
                $evalAsync: function (expr, locals) {
                    ...
                    if (msos.config.verbose) {
                        msos.console.debug(temp_rsp + temp_sy + 'start, asyncQueue: ' + asyncQueue.length);
                    }
                    ...
                    if (!$rootScope_P.$$phase && !asyncQueue.length) {
                        $browser.defer(
                            function () {
                                msos.console.debug(temp_rsp + temp_sy + '$browser.defer -> called, asyncQueue: ' + asyncQueue.length);
                    ...
                    if (msos.config.verbose) {
                        msos.console.debug(temp_rsp + temp_sy + ' done, asyncQueue: ' + asyncQueue.length + ', added: ' + (queue_obj.locals.directive_name || 'na'));
                    }
                },
                ...
                $apply: function (expr) {
                   ...
                   if (!expr) {
                    ...
                    if (msos.config.debug) {
                        msos.console.info(temp_rsp + temp_ap + 'start, ' + dbug_app + 'for phase: ' + $rootScope_P.$$phase);
                    }
    ...
    function $$SanitizeUriProvider() {
        ...
        msos.console.debug(temp_su + ' -> start.');
        ...
        this.$get = function () {
            return function sanitizeUri(uri, isImage) {
                ...
                msos.console.debug(temp_su + ' - $get - sanitizeUri -> start, uri: ' + uri);
                ...
                msos.console.debug(temp_su + ' - $get - sanitizeUri ->  done, uri: ' + uri);
                return uri;
            };
        };

        msos.console.debug(temp_su + ' -> done!');
    }
            ...
            function handleRequestFn(tpl) {
                ...
                function handleError(resp) {
                    if (msos.config.debug) {
                        ...
                        msos.console.warn('ng - $TemplateRequestProvider - $get - handleRequestFn -> failed, template: ' + tpl);
                    }
        ...
        this.$get = ['$rootScope', '$browser', '$q', '$$q', function ($rootScope, $browser, $q, $$q) {
            ...
            function timeout(fn, delay, invokeApply) {
                var temp_to = ' - $get - timeout -> ',
                    is_to_fn = _.isFunction(fn),
                    invokeApply_to = is_to_fn ? invokeApply : delay,
                    delay_to = is_to_fn ? delay : fn,
                    fn_to = is_to_fn ? fn : noop,
                ...
                msos.console.debug(temp_tp + temp_to + 'start, name: ' + promise.$$state.name + ', delay: ' + delay_to);
    ...
    function formatNumber(number, pattern, groupSep, decimalSep, fractionSize) {
        ...
        isInfinity = number === Infinity;

        if (!isInfinity && !_.isFinite(number)) { return ''; }
                    ...
                    return {
                        pre: function ngFormPreLink(scope, formElement, attr, controller) {
                            ...
                            function setter(obj, path, setValue, fullExp) {
                                ...
                                msos.console.debug(temp_fd + ' - setter -> start, path: ' + path);
                        
                                ensureSafeObject(obj, fullExp);
                        
                                for (i = 0; element.length > 1; i += 1) {
                                    key = ensureSafeMemberName(element.shift(), fullExp);
                                    propertyObj = obj[key] ? ensureSafeObject(obj[key], fullExp) : undefined;
                                ...
                                key = ensureSafeMemberName(element.shift(), fullExp);
                                if (obj[key]) { ensureSafeObject(obj[key], fullExp); }
                                obj[key] = setValue;
                        
                                msos.console.debug(temp_fd + ' - setter -> done!');
                                return setValue;
                            }
                        ...
                        Object.keys(values).forEach(
                            function getWatchable(key) {
                                ...
                                if (key.charAt(0) === '$') { return; }
                                    ...
                                    selectValue = getTrackByValueFn(values[key], locals);
...
msos.console.info('ng/v141_msos -> done!');
