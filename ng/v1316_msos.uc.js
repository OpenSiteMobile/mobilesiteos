...
msos.console.info('ng/v1316_msos -> start.');
...
(function (window, document) {
    ...
    var angular = {},
        version = {
            ...
            minor: 3,
            dot: 16,
            codeName: 'cookie_oatmealification_msos'
        },
        NODE_TYPE_ELEMENT = 1,
...
//            while ((token = this.expect('|'))) {
    ...
    function deepCompare(actual, expected, comparator, matchAgainstAnyProp, dontMatchWholeObject) {
        var actualType = (actual !== null) ? typeof actual : 'null',
            expectedType = (expected !== null) ? typeof expected : 'null',
            key,
            expectedVal,
            matchAnyProperty,
            actualVal;
                ...
                function setupAsSingle(scope, selectElement, ngModelCtrl, selectCtrl) {
                    ...
                    ngModelCtrl.$render = function () {
                        ...
                        if (selectCtrl.hasOption(viewValue)) {
                            ...
                            if (viewValue == null && emptyOption) {  // viewValue == null was _.undefined(viewValue), so viewValue can morph...is that good?
                                selectElement.val('');
                            } else {
...
msos.console.info('ng/v1316_msos -> done!');
