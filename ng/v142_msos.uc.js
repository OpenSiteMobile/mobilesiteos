...
msos.console.info('ng/v142_msos -> start.');
...
(function (window, document) {
    ...
    var angular = {},
        version = {
            ...
            minor: 4,
            dot: 2,
            codeName: 'nebular_readjustment_msos'
        },
                    ...
                    return {
                        pre: function ngFormPreLink(scope, formElement, attr, controller) {
                            ...
                            function setter(obj, path, setValue, fullExp) {
                                ...
                                msos_debug(temp_fd + ' - setter -> start, path: ' + path);
                                ...
                                msos_debug(temp_fd + ' - setter -> done!');
                                return setValue;
                            }
...
msos.console.info('ng/v142_msos -> done!');
