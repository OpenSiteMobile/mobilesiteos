 ...
 *       with updates from v1.3.3, thru v1.3.9,
 */
...
msos.console.info('ng/route/v139_msos -> start.');
                    ...
                    $q.when($q.defer('ng_route_when_commitRoute'), nextRoute).then(
                        function () {
                            if (nextRoute) {
                                ...
                                return $q.all($q.defer('all_commitRoute'), locals);
                            }
                            return undefined;
                        }
                    ).then(
...
msos.console.info('ng/route/v139_msos -> done!');
