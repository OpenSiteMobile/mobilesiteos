...
(function (w_angular, w_msos) {
    ...
    function ngViewFillContentFactory($compile, $route) {
        return {
            restrict: 'ECA',
            priority: -400,
    ...
    ngViewFillContentFactory.$inject = ['$compile', '$route'];

    function ngViewControllerFactory($controller, $route) {
        return {
            restrict: 'ECA',
            priority: -200,     // Run after ngViewFillContentFactory (watch weird ordering -200 and -400?)
            link: function (scope, $element) {
    ...
    ngViewControllerFactory.$inject = ['$controller', '$route'];


    ngRouteModule.directive('ngView', ngViewFactory);
    ngRouteModule.directive('ngView', ngViewFillContentFactory);
    ngRouteModule.directive('ngView', ngViewControllerFactory);     // Separating the Controller section works better, I believe
