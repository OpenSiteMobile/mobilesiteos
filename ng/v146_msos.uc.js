 ...
 *                          v1.3.15, v1.3.16, v1.4.1, v1.4.2, v1.4.5, v1.4.6
...
msos.console.info('ng/v146_msos -> start.');
...
(function (window, document) {
    ...
    var angular = {},
        version = {
            ...
            minor: 4,
            dot: 6,
            codeName: 'multiplicative_elevation_msos'
        },
    ...
    function copy(source, destination, stackSource, stackDest) {
        ...
        if (!destination) {
            ...
            if (isObject(source)) {
                ...
                } else if (_.isFunction(source.cloneNode)) {
    ...
    function ensureSafeMemberName(name, fullExpression) {
        ...
        name =  (_.isObject(name) && name.toString) ? name.toString() : name;
        ...
        return {
            ...
            compile: function (element, attr) {
                ...
                if (isDefined(attr.value)) {
                    valueInterpolated = $interpolate(attr.value, true);
                } else {
...
msos.console.info('ng/v146_msos -> done!');
