...
msos.onload_functions.push(
	function () {
        ...
        apps.customer.start.controller('CustomersController', function ($scope, customersService) {
        ...
        apps.customer.start.controller('CustomerOrdersController', function ($scope, $routeParams, customersService) {
            $scope.customer = {};
        ...
        apps.customer.start.controller('OrdersController', function ($scope, customersService) {
            $scope.customers = [];
        ...
        apps.customer.start.controller('NavbarController', function ($scope, $location) {
        ...
        apps.customer.start.controller('OrderChildController', function ($scope) {
