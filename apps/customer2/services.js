...
msos.provide('apps.customer2.services');


msos.onload_functions.push(
	function () {

		var temp_cs = 'apps.customer2.services -> ';

        //This handles retrieving data and is used by controllers. 3 options (server, factory, provider) with 
        //each doing the same thing just structuring the functions/data differently.
        apps.customer2.start.service('customersService', function () {
		...
		apps.customer2.start.service('modalService', ['$modal', function ($modal) {
