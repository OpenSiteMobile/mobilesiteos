...
msos.provide('apps.customer2.directives');


msos.onload_functions.push(
	function () {

		var temp_cd = 'apps.customer2.directives -> ';
        ...
        apps.customer2.start.directive('animatedView', ['$route', '$anchorScroll', '$compile', '$controller', function ($route, $anchorScroll, $compile, $controller) {
            return {
                restrict: 'ECA',
                terminal: true,
