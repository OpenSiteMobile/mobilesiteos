...
msos.provide("apps.bootstrap2.controllers.typeahead");
msos.require("ng.bootstrap.ui.typeahead");

apps.bootstrap2.controllers.typeahead.version = new msos.set_version(14, 8, 6);


angular.module(
    'apps.bootstrap2.controllers.typeahead', []
).controller(
    'apps.bootstrap2.controllers.typeahead.ctrl',
    [
        '$scope', '$http',
        function ($scope, $http) {
            "use strict";
