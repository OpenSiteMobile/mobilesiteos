...
msos.provide("apps.mediaelement.translate");
...
apps.mediaelement.translate.perl_script_uri = '../cgi-bin/site_translate.cgi';

apps.mediaelement.translate.insert_content = function (language, translation) {
    "use strict";
    ...
    if (!popup_confirm || popup_confirm.closed) {
        ...
        popup_confirm = msos.popwindesktop.open(
            apps.mediaelement.translate.perl_script_uri + '?back_url=' + encodeURIComponent(window.location.href),
            '_blank',
    ...
    if (!popup_submit || popup_submit.closed) {
        ...
        popup_submit = msos.popwindesktop.msos_std(
            ...
            'Submit',
            apps.mediaelement.translate.perl_script_uri
        );
        ...
        setTimeout(
            function () {
                ...
                apps.mediaelement.translate.insert_content(language, translation);
            },
            2500
        );
        return;
...
apps.mediaelement.translate.check_for_key = function () {
    "use strict";
    ...
    msos.console.debug('apps.mediaelement.translate.check_for_key -> input: ' + in_key_value + ', stored value: ' + store_value);
...
msos.onload_functions.push(
	function () {
        ...
        function submitChange() {
            ...
            if (!apps.mediaelement.translate.check_for_key()) {
        ...
        function change_language() {
            ...
            jQuery('#get_json_source').click(
                function () {
                    ...
                    apps.mediaelement.translate.insert_content(src_val, translated_source);
            ...
            jQuery('#get_json_destin').click(
                function () {
                    ...
                    apps.mediaelement.translate.insert_content(dest_val, translated_destin);
        ...
        jQuery('#google_api_key').blur(
            function () {
                if (apps.mediaelement.translate.check_for_key()) { change_language(); }
            }
        );
