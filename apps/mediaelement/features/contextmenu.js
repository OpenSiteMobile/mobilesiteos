...
msos.provide("apps.mediaelement.features.contextmenu");
...
msos.onload_func_start.push(
	function () {
		...
		msos.console.info('Content: contextmenu.html loaded!');
		...
		video.features_by_size.custom.push('fullscreen', 'contextmenu');

		mep.play.video.init(
			jQuery('#contextmenu_html'),
			video
		);
	}
);